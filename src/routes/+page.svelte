...
<div class="flex flex-col justify-around h-screen my-6">
	...
	<div class="text-center h-1/3">
		<p class="text-gray-400 text-4xl xl:text-6xl font-extralight">Do you have any proposal?</p>
		<p class="text-gray-300 text-3xl xl:text-5xl font-bold">Send me an
			<a href="mailto:erikpellizzon1@gmail.com" class="text-blue-400">email</a>
		</p>
	</div>
